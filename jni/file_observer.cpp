...
#define ALOGE(fmt) __android_log_print(ANDROID_LOG_ERROR, "XMMS2 FileObserver", fmt)
...
jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    clazz = env->FindClass("org/xmms2/service/medialib/updater/FileObserver$ObserverThread");

    if (clazz == NULL)
    {
        ALOGE("Can't find org/xmms2/service/medialib/updater/FileObserver$ObserverThread");
        return -1;
    }
